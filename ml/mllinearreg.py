...
while True:
    ...
    incr = all(i < j for i, j in zip(predictedSellPrices[0], predictedSellPrices[0][1:]))#https://www.geeksforgeeks.org/python-check-if-list-is-strictly-increasing/  if pred array increases the price trending up, buy
